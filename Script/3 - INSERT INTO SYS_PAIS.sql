...
DELETE FROM [cfg].[CIDADE]
GO
DELETE FROM [cfg].[ESTADO]
GO
DELETE FROM [cfg].[PAIS]
GO

INSERT INTO [cfg].[PAIS] (NOME, NOME_PT, SIGLA, BACEN) 
VALUES	('Brazil', 'Brasil', 'BR', 1058),
		...
		('Bouvet Island', 'Ilha Bouvet', 'BV', 3600),
		...
		('Macau', 'Macau', 'MO', 4472),
		('Macedonia, The Former Yugoslav Republic of', 'Macedônia, Antiga Republica Iugoslava', 'MK', 4499),
		...
		('Netherlands Antilles', 'Antilhas Holandesas', 'AN', 477),
		...
		('South Georgia and the South Sandwich Islands', 'Ilhas Geórgia do Sul e Sandwich do Sul', 'GS', 3602),
		...
		('Svalbard and Jan Mayen Islands', 'Svalbard e Jan Mayen', 'SJ', 3605),
		('Swaziland', 'Suazilândia', 'SZ', 7544),
		...
		('Canarias', 'Canarias, Ilhas', NULL, 1511),
		('Isle of Man', 'Man, Ilha de', 'IM', 3595),
		('Johnston Atoll', 'Johnston, Ilhas', NULL, 3964),
		('Madeira', 'Madeira, Ilha da', NULL, 4525),
		...
		('Wake', 'Wake, Ilha', NULL, 8737),
		('Labuan', 'Lebuan, Ilhas', NULL, 4235),
		('Dawlat Filasṭīn', 'Palestina', 'PS', 5780),
		('Åland Islands', 'Ilhas de Aland', 'AX', 3597),
		('Saint Barthélemy', 'Coletividade de São Bartolomeu', 'BL', 3598),
		('Curaçao', 'Curaçao', 'CW', 3601),
		('Saint Martin', 'Ilha de São Martinho (França)', 'MF', 3604),
		('Sint Maarten (Dutch part)', 'São Martinho (Países Baixos)', 'SX', 3606);
GO

SELECT * FROM [cfg].[PAIS]
GO