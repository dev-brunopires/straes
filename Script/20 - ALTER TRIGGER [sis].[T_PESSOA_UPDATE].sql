...
/****** Object:  Trigger [sis].[T_PESSOA_UPDATE]    Script Date: 19/08/2023 02:47:25 ******/
SET ANSI_NULLS ON
GO
...
ALTER TRIGGER [sis].[T_PESSOA_UPDATE]
   ON  [sis].[PESSOA]
   AFTER UPDATE
AS
BEGIN
	...
	BEGIN TRY
		BEGIN TRAN			
			...
			SELECT ID_PESSOA, ID_CLASSIFICACAO, ID_ATIVIDADE, ID_ESTADO_CIVIL, ID_CIDADE, MATRICULA, NOME, DT_NASCIMENTO, ATIVO, PAI, MAE, PROFISSAO, CONJUGE, 
                   RAZAO_SOCIAL, LOGRADOURO, NUMERO, COMPLEMENTO, BAIRRO, CEP, DATA_ADMISSAO_TERREIRO, DIGINA, ID_PADRINHO, PADRINHO_ORUNKO, USUARIO_OPERACAO, GETDATE(), 'UPDATE' FROM INSERTED 
		COMMIT TRAN
	END TRY
